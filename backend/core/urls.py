...
from .views import (
    ...
    AvailableSlotsView, ChatRoomListView, CreateChatRoomView, ChatMessagesView, SendMessageView, MarkMessagesAsReadView, SendAudioMessageView
)
...
urlpatterns = [
    ...
    path('chat/<int:room_id>/send-audio/', SendAudioMessageView.as_view(), name='send-audio'),
